...
class _DocumentVerificationScreenState
  ...
  bool _isNationalIdUploaded = false;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Verified workers earn 3× more bookings.",
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              "Verification pending — Admin reviews within 24 hours",
              style: TextStyle(color: Color(0xFFC2410C), fontSize: 13),
            ),
          ),
        ],
      ),
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.badge_outlined, color: primaryGreen),
              ),
              ...
              isUploaded
                  ...
                  : _uploadButton(
                      onPressed: () {
                        setState(() => _isNationalIdUploaded = true);
                      },
                    ),
            ],
          ),
  ...
  Widget _uploadButton({required VoidCallback onPressed}) {
    return OutlinedButton(
      ...
      child: const Text("Upload", style: TextStyle(color: primaryGreen)),
    );
  }
  ...
  Widget _buildPortfolioSection() {
    final canAddMorePhotos = _portfolioPhotos.length < 3;
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          "Show your past work — min 3 photos",
          style: TextStyle(color: Colors.grey, fontSize: 13),
        ),
        const SizedBox(height: 16),
        Row(
          children: List.generate(3, (index) {
            final hasPhoto = index < _portfolioPhotos.length;
            final isAddSlot =
                index == _portfolioPhotos.length && canAddMorePhotos;

            return Padding(
              padding: EdgeInsets.only(right: index == 2 ? 0 : 12),
              child: hasPhoto
                  ? _photoBox(photo: _portfolioPhotos[index])
                  : isAddSlot
                  ? _addPhotoBox()
                  : _photoBox(),
            );
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const WorkerServicePackagesScreen(),
                ),
              );
            },
            child: const Row(
